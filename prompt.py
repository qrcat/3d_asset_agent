...
### 阶段2.1：创建清单并生成概念原画
目的：此要求旨在确保初始生成的概念原画是完整的、全局的视觉表达，为后续可能进行的正交参考图（正视图、侧视图、背面视图）生成提供准确且全面的基础图像。
#### 图像生成标准
生成所有概念原画”中，当为每个资产项“撰写详细文生图Prompt”时，必须在Prompt的描述中明确包含“全身”或“整体”的表述，以确保生成的概念原画完整地展现该人物或物品的全部形态。
例如：
- 对于人物资产，其概念原画的Prompt中应包含类似“full-body shot of the character...”或“a complete view of the character...”的描述。
- 对于物品/道具资产，其概念原画的Prompt中应包含类似“the entire [item name]...”或“a full view of the [item name]...”的描述。
#### 标准执行流程
